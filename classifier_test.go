...
func TestDetectLineAspects(t *testing.T) {
	tests := []struct {
		name     string
		template string
		want     LineTypes
		...
		},
		{
			...
			template: "Text\n{{tag}}\nMore text",
			want:     LineTypes{{TextLine}, {StandaloneTagLine}, {TextLine}},
		...
		},
		{
			...
			template: "{{tag1}}\nText\n{{tag2}}",
			want:     LineTypes{{StandaloneTagLine}, {TextLine}, {StandaloneTagLine}},
		...
		},
		{
			...
			template: "{{tag1}}\nText\n{{tag2}}\n",
			want:     LineTypes{{StandaloneTagLine}, {TextLine}, {StandaloneTagLine}, {EmptyLine}},
		...
		},
		{
			...
			template: "Before\n{{#section}}\n  {{name}}\n{{/section}}\nAfter",
			want:     LineTypes{{TextLine}, {StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}, {TextLine}},
			comment:  "Section opening and closing tags should be standalone",
		},
		{
			name:     "Complex multi-line template with trailing newline",
			template: "Before\n{{#section}}\n  {{name}}\n{{/section}}\nAfter\n",
			want:     LineTypes{{TextLine}, {StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}, {TextLine}, {EmptyLine}},
		...
		},
		{
			...
			template: "{{#section}}\n{{>partial}}\n{{/section}}",
			want:     LineTypes{{StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}},
			comment:  "Different tag types can all be standalone",
		},
		{
			name:     "Different tag types in standalone positions with trailing newline",
			template: "{{#section}}\n{{>partial}}\n{{/section}}\n",
			want:     LineTypes{{StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}, {EmptyLine}},
		...
		},
		{
			...
			template: "<div>\n  {{tag}}\n</div>\n",
			want:     LineTypes{{TextLine}, {StandaloneTagLine}, {TextLine}, {EmptyLine}},
		...
		},
		{
			...
			template: "Text\n{{tag}}",
			want:     LineTypes{{TextLine}, {StandaloneTagLine}},
		...
		},
		{
			...
			template: "{{<parent}}\n{{$block}}Content{{/block}}\n{{/parent}}\n",
			want:     LineTypes{{StandaloneTagLine}, {InlineTagLine}, {StandaloneTagLine}, {EmptyLine}},
		...
		},
		{
			...
			template: "<html>\n  <body>\n    {{>header}}\n    <main>\n      {{#items}}\n        {{.}}\n      {{/items}}\n    </main>\n  </body>\n</html>",
			want:     LineTypes{{TextLine}, {TextLine}, {StandaloneTagLine}, {TextLine}, {StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}, {TextLine}, {TextLine}, {TextLine}},
			comment:  "Partial and section tags should be detected as standalone",
		},
		{
			name:     "Real-world indented template with trailing newline",
			template: "<html>\n  <body>\n    {{>header}}\n    <main>\n      {{#items}}\n        {{.}}\n      {{/items}}\n    </main>\n  </body>\n</html>\n",
			want:     LineTypes{{TextLine}, {TextLine}, {StandaloneTagLine}, {TextLine}, {StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}, {TextLine}, {TextLine}, {TextLine}, {EmptyLine}},
		...
		},
		{
			...
			template: "<div>\n    {{>partial}}\n        {{>partial}}\n</div>",
			want:     LineTypes{{TextLine}, {StandaloneTagLine}, {StandaloneTagLine}, {TextLine}},
			comment:  "Partial tags with different indentation levels",
		},
		{
			name:     "Partial with complex indentation with trailing newline",
			template: "<div>\n    {{>partial}}\n        {{>partial}}\n</div>\n",
			want:     LineTypes{{TextLine}, {StandaloneTagLine}, {StandaloneTagLine}, {TextLine}, {EmptyLine}},
		...
		},
		{
			...
			template: "{{ tag }}\n{{  tag  }}",
			want:     LineTypes{{StandaloneTagLine}, {StandaloneTagLine}},
		...
		},
		{
			...
			template: "{{ tag }}\n{{  tag  }}\n",
			want:     LineTypes{{StandaloneTagLine}, {StandaloneTagLine}, {EmptyLine}},
		...
		},
		{
			...
			template: "  /\\\n /  \\\n{{tag}}\n",
			want:     LineTypes{{TextLine}, {TextLine}, {StandaloneTagLine}, {EmptyLine}},
...
func TestComplexTemplates(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want:     LineTypes{{StandaloneTagLine}, {InlineTagLine}, {StandaloneTagLine}, {TextLine}, {TextLine}, {TextLine}, {TextLine}, {TextLine}, {StandaloneTagLine}, {StandaloneTagLine}},
		...
		},
		{
			...
			template: "{{<layout}}\n{{$title}}Page Title{{/title}}\n{{$content}}\n  <p>Page content</p>\n  <ul>\n    <li>Item 1</li>\n    <li>Item 2</li>\n  </ul>\n{{/content}}\n{{/layout}}\n",
			want:     LineTypes{{StandaloneTagLine}, {InlineTagLine}, {StandaloneTagLine}, {TextLine}, {TextLine}, {TextLine}, {TextLine}, {TextLine}, {StandaloneTagLine}, {StandaloneTagLine}, {EmptyLine}},
		...
		},
		{
			...
			template: "{{#outer}}\n  {{#inner}}\n    {{value}}\n  {{/inner}}\n{{/outer}}",
			want:     LineTypes{{StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}},
		...
		},
		{
			...
			template: "{{#outer}}\n  {{#inner}}\n    {{value}}\n  {{/inner}}\n{{/outer}}\n",
			want:     LineTypes{{StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}, {EmptyLine}},
		...
		},
		{
			...
			want:     LineTypes{{StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}},
		...
		},
		{
			...
			template: "{{user.name}}\n{{#user.settings.notifications}}\n  {{user.email}}\n{{/user.settings.notifications}}\n",
			want:     LineTypes{{StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}, {StandaloneTagLine}, {EmptyLine}},
			comment:  "Tags with complex paths and dot notation can be standalone; trailing newline creates an empty line",
		},
		{
			name:     "Comment tags",
			template: "{{! This is a comment }}\nContent\n{{! \n  Multi-line\n  comment\n}}\nMore content",
			want:     LineTypes{{StandaloneTagLine}, {TextLine}, {MultilineTagBegin, StandaloneTagLine}, {MultilineTagMiddle}, {MultilineTagMiddle}, {MultilineTagEnd, StandaloneTagLine}, {TextLine}},
		...
		},
		{
			...
			template: "{{! This is a comment }}\nContent\n{{! \n  Multi-line\n  comment\n}}\nMore content\n",
			want:     LineTypes{{StandaloneTagLine}, {TextLine}, {MultilineTagBegin, StandaloneTagLine}, {MultilineTagMiddle}, {MultilineTagMiddle}, {MultilineTagEnd, StandaloneTagLine}, {TextLine}, {EmptyLine}},
		...
		},
		{
			...
			template: "{{{unescaped}}}\n{{&alsoUnescaped}}",
			want:     LineTypes{{StandaloneTagLine, TripleBraceUnescaped}, {AmpersandUnescaped, StandaloneTagLine}},
			comment:  "Unescaped variable tags can be standalone",
		},
		{
			name:     "Unescaped variable tags with trailing newline",
			template: "{{{unescaped}}}\n{{&alsoUnescaped}}\n",
			want:     LineTypes{{StandaloneTagLine, TripleBraceUnescaped}, {AmpersandUnescaped, StandaloneTagLine}, {EmptyLine}},
...
func TestEdgeCases(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			template: "\u2003\u2002{{tag}}\u2003\u2002",
			want:     LineTypes{{InlineTagLine}}, // Most implementations only treat ASCII whitespace as whitespace
		...
		},
		{
			...
			template: "{{\ntag\n}}",
			want:     LineTypes{{MultilineTagBegin, StandaloneTagLine}, {MultilineTagMiddle}, {MultilineTagEnd, StandaloneTagLine}},
			comment:  "Multi-line tag contents are properly identified as beginning, middle, and end",
		},
		{
			name:     "Multiple sequential newlines",
			template: "{{tag}}\n\n\n{{tag}}",
			want:     LineTypes{{StandaloneTagLine}, {EmptyLine}, {EmptyLine}, {StandaloneTagLine}},
			comment:  "Multiple empty lines between tags",
		},
		{
			name:     "Multiple sequential newlines with trailing newline",
			template: "{{tag}}\n\n\n{{tag}}\n",
			want:     LineTypes{{StandaloneTagLine}, {EmptyLine}, {EmptyLine}, {StandaloneTagLine}, {EmptyLine}},
